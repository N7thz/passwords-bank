...
import {
    registerPasswordSchema, RegisterPasswordSchema
        ...
        <Form {...form}>
            ...
            >
                ...
                <div className="space-y-0.5">
                    ...
                    {
                        errors.site && (
                            <SpanErrorMessage message={errors.site.message} />
                        )
                    }
                </div>
                <div className="space-y-0.5">
                    <Input
                        ...
                        {...register("account")}
                        className={cn(
                            (dirtyFields.account && !errors.account) && [
                                "focus-visible:ring-primary",
                                "not-focus-visible:border-primary"
                            ],
                            errors.account && [
